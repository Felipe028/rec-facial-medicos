    ...
    <div class="row mt-0">
      <div class="col-12">
        <card card-body-classes="table-full-width">
          <h4 slot="header" class="card-title text-left">Listagem de Solicitação - Mobile</h4>
          <div>
                ...
                <div class="d-flex justify-content-center justify-content-sm-between flex-wrap">
                    <div>
                        <el-select
                            ...
                            v-model="empresa"
                        >
                            <el-option class="select-success" value="Todos">Todos</el-option>
                            <el-option class="select-success" value="Empresa Sede">Empresa Sede</el-option>
                            <el-option class="select-success" value="Empresa Secundária">Empresa Secundária</el-option>
                        </el-select>                        
                    </div>
            ...
            <el-table :data="queriedData">
              ...
              <el-table-column :min-width="135" align="right" label="Actions">
                <div slot-scope="props">
                  ...
                  <base-button
                    @click.native="handleLike(props.$index, props.row, dialogEditar = true)"
                    class="edit btn-link"
                    type="info"
                    size="sm"
                    icon
                  ...
                  <modal :show.sync="dialogEditar">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label for="postoTrabalho" class="form-label  text-left w-100">Filial/Posto de trabalho</label>
                                <el-select
                                    class="select-success pagination-select w-100"
                                    id="postoTrabalho"
                                    v-model="horarioSelecionado"
                                    placeholder="Filial/Posto de trabalho"
                                >
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label for="postoTrabalho" class="form-label  text-left w-100">Permissão para usar a versão mobile</label>
                                <el-select
                                    class="select-success pagination-select w-100"
                                    id="postoTrabalho"
                                    v-model="horarioSelecionado"
                                    placeholder="Permissão para usar a versão mobile"
                                >
                                    <el-option class="select-success" label="Sim" value="03:00" selected>Sim</el-option>
                                    <el-option class="select-success" label="Não" value="04:00">Não</el-option>
                                </el-select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label for="postoTrabalho" class="form-label  text-left w-100">Supervisor</label>
                                <el-select
                                    class="select-success pagination-select w-100"
                                    id="postoTrabalho"
                                    v-model="horarioSelecionado"
                    ...
                    <template slot="footer">
                        <base-button type="danger" @click="dialogEditar = false">Fechar</base-button>
