    ...
    methods:{
        ...
        async registrarPonto(img){
            ...
            .then(coordinates => {
                ...
                .then((response) => {
                    th.isLoading = false
                    th.showSwal2('auto-close', 'Sucesso', 'Ponto registrado com sucesso!', 'success')
                    if(th.typePonto == 1){
                        th.$cookies.keys().forEach(cookie => this.$cookies.remove(cookie));
                        th.$router.push("/");
                    }else{
                        location.reload()
                    }
...
//            bus.$emit('limpalist');
        ...
        loadCameras() {
            ...
            CapturarImagem() {
                ...
                jsonn.append("nrCpf", "00480208263")
                ...
                .then(function(response) {
                    ...
                    if(response.data.default_face_matching_classification && response.data.message == "User successfully registered"){
                        ...
                        current.$root.$emit('verificarFoto', "if - nao tinha foto")
                        ...
                        current.$root.$emit('verificarFoto', img)
                    } else {
